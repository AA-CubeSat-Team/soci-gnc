function [pos_teme_km,vel_teme_kmps,FLAG] = matlab_sgp4(JD_J2000_cur,orbit_tle)
...
%
% Inputs:
%   - orbit_tle: NORAD two line element set containing orbit info with
%   angles in degrees
%   - JD_J2000_cur: current Julian date since the J2000 epoch
% Outputs:
