 function [itrf_to_gcrf, ppef_to_vgcrf, tod_to_gcrf, teme_to_gcrf] = ...
            matlab_coordinate_rotations(jd_ut1_j2000_century, jd_tt_j2000_century)
%MATLAB_COORINATE_ROTATIONS
%
% Matlab version of the coordinate rotations function implemented in
% simulink.
%
% Excludes the polar motion transformation. Hence it
...
tod_to_gcrf  = mod_to_gcrf * tod_to_mod;
