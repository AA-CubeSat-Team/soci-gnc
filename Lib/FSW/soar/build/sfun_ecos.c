 ...
 *
 *         callecos(int32 u1,int32 u2,int32 u3,int32 u4,int32 u5,double u6[332],int32 u7[333],int32 u8[834],double u9[834],double u10[474],int32 u11[21],int32 u12[333],int32 u13[1278],double u14[1278],double u15[117],double y1[333])
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 25-May-2021 21:22:42
 *
...
/**
     ...
     def.OutputFcnSpec = 'callecos(int32 u1,int32 u2,int32 u3,int32 u4,int32 u5,double u6[332],int32 u7[333],int32 u8[834],double u9[834],double u10[474],int32 u11[21],int32 u12[333],int32 u13[1278],double u14[1278],double u15[117],double y1[333])';
     def.HeaderFiles = {'ecos.h'};
     def.SourceFiles = {'matlab_main.c', 'cone.c', 'ctrlc.c', 'ecos.c', 'equil.c', 'expcone.c', 'kkt.c', 'preproc.c', 'spla.c', 'splamm.c', 'wright_omega.c', 'ldl.c', 'amd_1.c', 'amd_2.c', 'amd_aat.c', 'amd_control.c', 'amd_defaults.c', 'amd_dump.c', 'amd_global.c', 'amd_info.c', 'amd_order.c', 'amd_post_tree.c', 'amd_postorder.c', 'amd_preprocess.c', 'amd_valid.c'};
