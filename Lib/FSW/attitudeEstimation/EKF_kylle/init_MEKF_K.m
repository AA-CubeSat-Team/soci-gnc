...
sig_v = sqrt(100)*1e-7;% zero mean gaussian covariance of gyro process noise
sig_u = sqrt(6)*1e-10; % gyro random walk seems to work beter and converge quicker when this is smaller than sig_v
