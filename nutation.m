...
function [deltapsi, trueeps, meaneps,nut] = nutation(ttt, ddpsi, ddeps);
        ...
        %final nutation parameters, see page 226 equ. 3-84 of Vallado
        deltapsi = mod( deltapsi + ddpsi, 2.0 * pi );
        deltaeps = mod( deltaeps + ddeps, 2.0 * pi );
        trueeps  = meaneps + deltaeps; %true obliquity of ecliptic, pg 226 equ. 3-85 of Vallado
