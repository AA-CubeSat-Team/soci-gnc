...
## Generated on : Sat Apr 17 16:27:35 2021
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/FSW_Lib0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/FSW_Lib0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/FSW_Lib0_ert_rtw -I/Users/Taylor/SOCI/soci-gnc/Lib/FSW/soar/include/ecos/include -I/Users/Taylor/SOCI/soci-gnc/Src -I/Users/Taylor/SOCI/soci-gnc/Lib/FSW/soar/include/ecos/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=FSW_Lib0 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
OBJS = CrossProdMatrix_lib.o FSW_Lib0.o FSW_Lib0_data.o L_inf_allocation_lib.o MEKF_lib.o PD_Controller_Lib.o TRIADActivation_lib.o asmController_lib.o maggyroProcessing_lib.o mode_select_lib.o parallel_protection_lib.o quat_err_lib.o quat_rectify_lib.o rt_sys_MEKF_lib_38.o rt_sys_MEKF_lib_42.o rt_sys_MEKF_lib_49.o rwa_allocation_lib.o sunSeek_lib.o target_generation_lib.o target_groundpass_lib.o twonorm.o expcone.o amd_1.o amd_2.o amd_aat.o amd_control.o amd_defaults.o amd_dump.o amd_global.o amd_info.o amd_order.o amd_post_tree.o amd_postorder.o amd_preprocess.o amd_valid.o cone.o ctrlc.o ecos.o equil.o kkt.o ldl.o matlab_main.o preproc.o runecos.o spla.o splamm.o timer.o wright_omega.o
