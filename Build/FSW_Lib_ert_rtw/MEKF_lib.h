...
typedef struct {
  DW_IfWarningError IfWarningError_c;  /* '<S189>/If Warning//Error' */
  DW_TRIADActivation_lib TRIADActivation_lib_a;/* '<S3>/TRIADActivation_lib' */
  real_T Id_3[9];                      /* '<S163>/Id_3' */
  real_T Merge[4];                     /* '<S186>/Merge' */
  ...
  real_T UnitDelay_DSTATE_c[4];        /* '<S124>/Unit Delay' */
  boolean_T DelayInput1_DSTATE;        /* '<S155>/Delay Input1' */
} DW_MEKF_lib;
