...
typedef struct {
  DW_ThreeValid_MVS ThreeValid_MVS_g;  /* '<S12>/ThreeValid_MVS' */
  void* Assertion_slioAccessor;        /* '<S36>/Assertion' */
  void* Assertion_slioAccessor_g;      /* '<S35>/Assertion' */
...
typedef struct {
  DW_ThreeValid_MVS ThreeValid_MVS_k;  /* '<S13>/ThreeValid_MVS' */
  void* Assertion_slioAccessor;        /* '<S78>/Assertion' */
  void* Assertion_slioAccessor_l;      /* '<S77>/Assertion' */
...
extern void maggyroProcessing_lib(const real_T rtu_sensor_meas_data[9], const
  ...
  real_T rtp_Gain);
extern void maggyroProcessing_lib1_Init(DW_maggyroProcessing_lib_j *localDW);
