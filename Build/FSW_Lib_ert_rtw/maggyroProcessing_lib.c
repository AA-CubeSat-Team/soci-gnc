                    ...
                    DW_ThreeValid_MVS *localDW, real_T rtp_max_err)
{
  ...
  real_T rtb_Median[3];
  real_T rtb_VariableSelector2_d[3];

  /* S-Function (sdspmdn2): '<S26>/Median' */
  c = 0;
  for (j = 0; j < 3; j++) {
    i0 = localDW->Median_Index[0];
    rtb_Sqrt_k = rtu_sensor_meas_body_all[localDW->Median_Index[0] + j];
    i1 = localDW->Median_Index[1U];
    rtb_Sqrt_p = rtu_sensor_meas_body_all[localDW->Median_Index[1U] + j];
    if (rtb_Sqrt_k > rtb_Sqrt_p) {
      localDW->Median_Index[1U] = localDW->Median_Index[0];
      localDW->Median_Index[0U] = i1;
    } else {
      rtb_Sqrt_k = rtb_Sqrt_p;
      i0 = localDW->Median_Index[1U];
    }

    i1 = localDW->Median_Index[2U];
    rtb_Sqrt_p = rtu_sensor_meas_body_all[localDW->Median_Index[2U] + j];
    if (rtb_Sqrt_k > rtb_Sqrt_p) {
      localDW->Median_Index[2U] = i0;
      if (rtu_sensor_meas_body_all[localDW->Median_Index[0U] + j] > rtb_Sqrt_p)
      {
   ...
   *  S-Function (sdspperm2): '<S26>/Variable Selector2'
   */
  rtb_VariableSelector2_d[0] = rtu_sensor_meas_body_all[3] -
   ...
   *  S-Function (sdspperm2): '<S26>/Variable Selector2'
   */
  rtb_VariableSelector2_d[1] = rtu_sensor_meas_body_all[4] -
   ...
   */
  *rty_sensor_meas_valid = ((rtb_Sqrt_k <= rtp_max_err) || (rtb_Sqrt_p <=
    rtp_max_err) || (rtb_Sqrt_e3 <= rtp_max_err));
}
              ...
              rty_sensor_meas_valid, real_T rtp_max_err)
{
  ...
  if (rtu_sensor_valid_all) {
     ...
     *  S-Function (sdspperm2): '<S27>/Variable Selector8'
     */
    rtb_Subtract_ac[0] = rtu_sensor_meas_body_all[3] - rtu_sensor_meas_body_all
      [6];
     ...
     *  S-Function (sdspperm2): '<S27>/Variable Selector8'
     */
    rtb_Subtract_ac[1] = rtu_sensor_meas_body_all[4] - rtu_sensor_meas_body_all
      [7];
     ...
     *  S-Function (sdspperm2): '<S27>/Variable Selector8'
     */
    rtb_Subtract_ac[2] = rtu_sensor_meas_body_all[5] - rtu_sensor_meas_body_all
      [8];

    /* Outputs for Atomic SubSystem: '<S53>/twonorm' */
    rtb_Sqrt_ac = twonorm(rtb_Subtract_ac);
     ...
     */
    *rty_sensor_meas_valid = (rtb_Sqrt_ac <= rtp_max_err);
  ...
  if (rtu_sensor_valid_all_c) {
     ...
     */
    rtb_Subtract_ac[0] = rtu_sensor_meas_body_all[3];
    rtb_Subtract_ac[1] = rtu_sensor_meas_body_all[4];
    rtb_Subtract_ac[2] = rtu_sensor_meas_body_all[5];
    ...
    rtb_Subtract_ac[0] = 0.0;

    /* Sum: '<S52>/Subtract' incorporates:
     *  S-Function (sdspperm2): '<S27>/Variable Selector6'
     *  S-Function (sdspperm2): '<S27>/Variable Selector8'
     */
    rtb_Subtract_f[0] = rtu_sensor_meas_body_all[0] - rtu_sensor_meas_body_all[6];

    /* SignalConversion: '<S52>/OutportBuffer_InsertedFor_nullOut_at_inport_0' */
    rtb_Subtract_ac[1] = 0.0;

    /* Sum: '<S52>/Subtract' incorporates:
     *  S-Function (sdspperm2): '<S27>/Variable Selector6'
     *  S-Function (sdspperm2): '<S27>/Variable Selector8'
     */
    rtb_Subtract_f[1] = rtu_sensor_meas_body_all[1] - rtu_sensor_meas_body_all[7];

    /* SignalConversion: '<S52>/OutportBuffer_InsertedFor_nullOut_at_inport_0' */
    rtb_Subtract_ac[2] = 0.0;

    /* Sum: '<S52>/Subtract' incorporates:
     *  S-Function (sdspperm2): '<S27>/Variable Selector6'
     *  S-Function (sdspperm2): '<S27>/Variable Selector8'
     */
    rtb_Subtract_f[2] = rtu_sensor_meas_body_all[2] - rtu_sensor_meas_body_all[8];

    /* Outputs for Atomic SubSystem: '<S52>/twonorm' */
    rtb_Sqrt_ac = twonorm(rtb_Subtract_f);
  ...
  if (!rtu_sensor_valid_all_d) {
    ...
    rtb_Sqrt_ac = twonorm(rtb_VariableSelector6_ix);
   ...
   *  Sum: '<S27>/Sum1'
   */
  rty_sensor_meas_body[0] = ((rtb_Merge_i_idx_0 + rtb_Subtract_ac[0]) +
    rtb_VariableSelector8_o_idx_0) * 0.5;
  rty_sensor_meas_body[1] = ((rtb_Merge_i_idx_1 + rtb_Subtract_ac[1]) +
    rtb_VariableSelector8_o_idx_1) * 0.5;
  rty_sensor_meas_body[2] = ((rtb_Merge_i_idx_2 + rtb_Subtract_ac[2]) +
...
void maggyroProcessing_lib_Init(DW_maggyroProcessing_lib *localDW)
{
  ...
  ThreeValid_MVS_Init(&localDW->ThreeValid_MVS_g);
  ...
  rtp_static_range_max_value, real_T rtp_Gain)
{
  ...
  for (i = 0; i < 3; i++) {
    ...
    rtb_VectorConcatenate[3 + i] += rtCP_Constant1_Value_j[i] *
      rtu_sensor_meas_data[3];
    rtb_VectorConcatenate[3 + i] += rtCP_Constant1_Value_j[i + 3] *
      rtu_sensor_meas_data[4];
    rtb_VectorConcatenate[3 + i] += rtCP_Constant1_Value_j[i + 6] *
   ...
   */
  rtb_conjunction_a = ((0.0 <= rtb_Sqrt_b) && (rtb_Sqrt_b <=
    rtp_static_range_max_value));
   ...
   */
  rtb_conjunction_l = ((0.0 <= rtb_Sqrt_b) && (rtb_Sqrt_b <=
    rtp_static_range_max_value));
  ...
  if (tmp && rtb_Merge2) {
     ...
     */
    ThreeValid_MVS(rtb_VectorConcatenate, rtb_Merge_p, rty_sensor_valid,
                   &localDW->ThreeValid_MVS_g, rtp_max_err);
...
void maggyroProcessing_lib1_Init(DW_maggyroProcessing_lib_j *localDW)
{
  /* SystemInitialize for IfAction SubSystem: '<S13>/ThreeValid_MVS' */
  ThreeValid_MVS_Init(&localDW->ThreeValid_MVS_k);
...
void maggyroProcessing_lib1(const real_T rtu_sensor_meas_data[9], const
  ...
  rty_sensor_valid, DW_maggyroProcessing_lib_j *localDW, real_T rtp_max_err,
  const real_T rtp_offset_calibration_matrix[9], real_T
  rtp_static_range_max_value, real_T rtp_Gain)
{
  real_T rtb_VectorConcatenate[9];
  ...
  rtb_Sqrt_a = twonorm(rtb_VariableSelector6);
   ...
   */
  rtb_conjunction = ((0.0 <= rtb_Sqrt_a) && (rtb_Sqrt_a <=
    rtp_static_range_max_value));
  ...
  rtb_Sqrt_a = twonorm(rtb_VariableSelector7);
   ...
   */
  rtb_conjunction_b = ((0.0 <= rtb_Sqrt_a) && (rtb_Sqrt_a <=
    rtp_static_range_max_value));
  ...
  rtb_Sqrt_a = twonorm(rtb_VariableSelector8);
   ...
   */
  rtb_conjunction_d = ((0.0 <= rtb_Sqrt_a) && (rtb_Sqrt_a <=
    rtp_static_range_max_value));
  ...
  if (tmp && rtb_Merge2) {
     ...
     */
    ThreeValid_MVS(rtb_VectorConcatenate, rtb_Merge_f, rty_sensor_valid,
                   &localDW->ThreeValid_MVS_k, rtp_max_err);
