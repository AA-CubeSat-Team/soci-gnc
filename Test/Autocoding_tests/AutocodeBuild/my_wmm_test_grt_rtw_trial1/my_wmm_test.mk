###########################################################################
## Makefile generated for Simulink model 'my_wmm_test'. 
## 
## Makefile     : my_wmm_test.mk
## Generated on : Sun May 03 13:59:30 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/my_wmm_test
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/devantormey/Documents/MATLAB/UW/AACT/soci-gnc/Test/Autocoding_tests/PipelineTests
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/my_wmm_test
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/my_wmm_test_grt_rtw -I/Users/devantormey/Documents/MATLAB/UW/AACT/soci-gnc/Test/Environment/magField -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=my_wmm_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/my_wmm_test_grt_rtw/my_wmm_test.c $(START_DIR)/my_wmm_test_grt_rtw/my_wmm_test_data.c $(START_DIR)/my_wmm_test_grt_rtw/rtGetInf.c $(START_DIR)/my_wmm_test_grt_rtw/rtGetNaN.c $(START_DIR)/my_wmm_test_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.o my_wmm_test.o my_wmm_test_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/my_wmm_test_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/my_wmm_test_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
