...
## Generated on : Sun May 03 14:05:58 2020
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/my_wmm_test_ert_rtw -I/Users/devantormey/Documents/MATLAB/UW/AACT/soci-gnc/Test/Environment/magField -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=my_wmm_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
SRCS = $(START_DIR)/my_wmm_test_ert_rtw/my_wmm_test.c $(START_DIR)/my_wmm_test_ert_rtw/rtGetInf.c $(START_DIR)/my_wmm_test_ert_rtw/rtGetNaN.c $(START_DIR)/my_wmm_test_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/my_wmm_test_ert_rtw/ert_main.c
...
OBJS = my_wmm_test.o rtGetInf.o rtGetNaN.o rt_nonfinite.o
...
%.o : $(START_DIR)/my_wmm_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/my_wmm_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
