...
## Generated on : Tue Feb 11 14:54:22 2020
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/sunVector_test_ert_rtw -I$(START_DIR)/Test/Autocoding_tests -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=sunVector_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/sunVector_test_ert_rtw/sunVector_test.c

MAIN_SRC = $(START_DIR)/sunVector_test_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/sunVector_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/sunVector_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
