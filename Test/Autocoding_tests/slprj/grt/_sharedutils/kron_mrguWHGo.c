/*
 * /Users/devantormey/Documents/MATLAB/UW/AACT/soci-gnc/Test/Autocoding_tests/slprj/grt/_sharedutils/kron_mrguWHGo.c
 *
...
void kron_mrguWHGo(const real_T A[100], const real_T B[9], real_T K[900])
{
  int32_T kidx;
  int32_T b_j1;
  int32_T j2;
