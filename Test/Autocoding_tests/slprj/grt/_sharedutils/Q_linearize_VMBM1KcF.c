/*
 * /Users/devantormey/Documents/MATLAB/UW/AACT/soci-gnc/Test/Autocoding_tests/slprj/grt/_sharedutils/Q_linearize_VMBM1KcF.c
 *
 ...
 */
void Q_linearize_VMBM1KcF(const real_T x[10], const real_T u[3], const real_T J
  [9], real_T A[100], real_T f[10])
{
  ...
  /* '<S6>:1:270' dfq_dq      = 0.5 * [ 0 -w'; w -skew(w) ]; */
  /* 'skew:8' if( length(v) ~= 3 ) */
  /* 'skew:12' v_skew  = [ 0       -v(3)   v(2); */
  /* 'skew:13'             v(3)    0       -v(1); */
  /* 'skew:14'             -v(2)   v(1)    0 ]; */
  /* '<S6>:1:271' dfq_dhb     = 0.5 * [ -qv'; skew(qv)+q0*eye(3) ]/J; */
  /* 'skew:8' if( length(v) ~= 3 ) */
  /* 'skew:12' v_skew  = [ 0       -v(3)   v(2); */
  /* 'skew:13'             v(3)    0       -v(1); */
  /* 'skew:14'             -v(2)   v(1)    0 ]; */
  ...
  /* '<S6>:1:272' dfq_dhw     = zeros(4,3); */
  /* '<S6>:1:273' dfhb_dq     = zeros(3,4); */
  /* '<S6>:1:274' dfhb_dhb    = skew(hb)/J - skew(w) + skew(hw)/J; */
  /* 'skew:8' if( length(v) ~= 3 ) */
  /* 'skew:12' v_skew  = [ 0       -v(3)   v(2); */
  /* 'skew:13'             v(3)    0       -v(1); */
  /* 'skew:14'             -v(2)   v(1)    0 ]; */
  ...
  /* 'skew:13'             v(3)    0       -v(1); */
  /* 'skew:14'             -v(2)   v(1)    0 ]; */
  /* '<S6>:1:275' dfhb_dhw    = -skew(w); */
  /* 'skew:8' if( length(v) ~= 3 ) */
  /* 'skew:12' v_skew  = [ 0       -v(3)   v(2); */
  /* 'skew:13'             v(3)    0       -v(1); */
  /* 'skew:14'             -v(2)   v(1)    0 ]; */
  /* '<S6>:1:276' dfhw_dq     = zeros(3,4); */
  /* '<S6>:1:277' dfhw_dhb    = zeros(3,3); */
  /* '<S6>:1:278' dfhw_dhw    = zeros(3,3); */
  /* '<S6>:1:279' dfq_du      = zeros(4,3); */
  /* '<S6>:1:280' dfhb_du     = -eye(3); */
  /* '<S6>:1:281' dfhw_du     = eye(3); */
  /* '<S6>:1:284' fq  = 0.5 * [ -qv'; skew(qv)+q0*eye(3) ] * w; */
  /* 'skew:8' if( length(v) ~= 3 ) */
  /* 'skew:12' v_skew  = [ 0       -v(3)   v(2); */
  /* 'skew:13'             v(3)    0       -v(1); */
  /* 'skew:14'             -v(2)   v(1)    0 ]; */
  /* '<S6>:1:285' fhb = -u + skew(hb+hw)*w; */
  maxval = x[4] + x[7];
  scale = x[5] + x[8];
  absxk = x[6] + x[9];
  ...
  /* '<S6>:1:290' A = [ dfq_dq dfq_dhb dfq_dhw; */
  /* '<S6>:1:291'       dfhb_dq dfhb_dhb dfhb_dhw; */
  /* '<S6>:1:292'       dfhw_dq dfhw_dhb dfhw_dhw ]; */
  tmp[0] = 0.0;
  tmp[3] = -x[6];
  tmp[6] = x[5];
  tmp[1] = x[6];
  ...
  /* '<S6>:1:293' B = [ dfq_du; dfhb_du; dfhw_du ]; */
}
