...
MODEL               = UnitTestDebug
MODULES             = rt_logging.c UnitTestDebug.c UnitTestDebug_capi.c UnitTestDebug_data.c UnitTestDebug_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE            = UnitTestDebug.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/kylle/Desktop/GitHub/soci-gnc
...
BUILDARGS           =  MODELLIB=UnitTestDebuglib.lib RSIM_SOLVER_SELECTION=2 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = UnitTestDebug_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/UnitTestDebug \
	-I$(START_DIR)/Test/ESTIMA~1/UNITTE~1/FULLFU~1 \
