###########################################################################
## Makefile generated for Simulink model 'sunVector_test'. 
## 
## Makefile     : sunVector_test.mk
## Generated on : Tue Feb 11 13:51:15 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sunVector_test.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/SOCI/soci-gnc/Test/Autocoding_tests
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = sunVector_test_comp.rsp
CMD_FILE                  = sunVector_test.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sunVector_test.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/sunVector_test_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=sunVector_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/sunVector_test_grt_rtw/rtGetInf.c $(START_DIR)/sunVector_test_grt_rtw/rtGetNaN.c $(START_DIR)/sunVector_test_grt_rtw/rt_nonfinite.c $(START_DIR)/sunVector_test_grt_rtw/sunVector_test.c $(START_DIR)/sunVector_test_grt_rtw/sunVector_test_data.c
...
OBJS = rt_logging.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj sunVector_test.obj sunVector_test_data.obj
...
%.obj : $(START_DIR)/sunVector_test_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/sunVector_test_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
