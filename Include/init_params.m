...
[fswParams, simParams] = default_config(TLE);
...
% Set up parameters for the flatsat interface
[simParams] = FlatSat_init(fswParams, simParams);

% Printout some information about the sim configuration
sim_config_display(fswParams, simParams);
